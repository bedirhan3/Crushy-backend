    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchedUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchedUsers_Users_User1Id",
                        column: x => x.User1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchedUsers_Users_User2Id",
                        column: x => x.User2Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchedUsers_User1Id",
                table: "MatchedUsers",
                column: "User1Id");

            migrationBuilder.CreateIndex(
                name: "IX_MatchedUsers_User2Id",
                table: "MatchedUsers",
                column: "User2Id");
